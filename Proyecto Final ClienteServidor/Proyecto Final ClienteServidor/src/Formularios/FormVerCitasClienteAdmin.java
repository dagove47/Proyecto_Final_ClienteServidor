...
public class FormVerCitasClienteAdmin extends javax.swing.JFrame {

    Conexion cc = new Conexion();
    Connection  con = cc.conectar();
    Statement st;

    public FormVerCitasClienteAdmin() {
        initComponents();
    ...
    private void initComponents() {
        ...
        imgfondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/Osoimg.jpg"))); // NOI18N
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormVerCitasClienteAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormVerCitasClienteAdmin().setVisible(true);
            }
        });
    }
